...
spec:
  ...
  # startingCSV: spring-boot-operator.v0.1.2
```
...
spring-boot-operator.v0.1.2    Spring Boot Operator    0.1.2                Succeeded
```
...
kubectl delete csv spring-boot-operator.v0.1.2 -n spring-boot-operator-system
...
```bash
kubectl describe csv spring-boot-operator.v0.1.2 -n spring-boot-operator-system
```
